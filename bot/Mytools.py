...
def bazi_cesuan(query:str):
    ...
    chain = prompt | ChatTongyi(temperature=0,model_name="qwen-vl-max",dashscope_api_key = dashscope_api_key) | parser
...
def jiemeng(query:str):
    ...
    LLM = Tongyi(temperature=0,model="Qwen-max",dashscope_api_key = dashscope_api_key)
